...
try {
  ...
  Write-Host "[build] $cxx -std=c++17 -I magichid tests/*.cpp"
  & $cxx -std=c++17 -O1 -I magichid tests/test_main.cpp tests/test_policy.cpp tests/test_parity.cpp tests/test_horipad.cpp -o $bin
